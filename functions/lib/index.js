...
exports.verifyRazorpayPayment = exports.createRazorpayOrder = exports.deleteUserAccount = exports.getRelatedSkills = exports.generateAssessmentQuestions = exports.enhanceText = exports.bulkPostJobs = exports.generateJobDescription = exports.onMessageCreated = void 0;
 ...
 */
exports.createRazorpayOrder = (0, https_1.onCall)({ secrets: ["RAZORPAY_KEY_SECRET"], region: "us-central1" }, async (request) => {
    // 1. Strict Authentication Check
    if (!request.auth || !request.auth.uid) {
 ...
 */
exports.verifyRazorpayPayment = (0, https_1.onCall)({ secrets: ["RAZORPAY_KEY_SECRET"], region: "us-central1" }, async (request) => {
    var _a, _b;
    // 1. Strict Authentication Check
    if (!request.auth || !request.auth.uid) {
